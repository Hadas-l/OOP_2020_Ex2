...
//                updateEdge(f, _gg);
    ...
    private static edge_data find_edge(geo_location fr_loc, int fr_type, directed_weighted_graph g) {
        ...
        while(itr.hasNext()) {
            ...
            while(iter.hasNext()) {
                ...
                boolean f = isOnEdge(fr_loc, e, fr_type, g);
                if(f) {
//                    System.out.println("f " + e.getDest());
                    return e;
                }
            }
        }
